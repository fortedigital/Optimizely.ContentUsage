...
{
    public static IEnumerable<ContentUsageWithCount> Sort(this IEnumerable<ContentUsageWithCount> collection, GetContentUsagesQuery query)
    {
        return query?.SortBy switch
        {
            ...
            ContentUsageSorting.UsageCount => collection.SortBy(dto => dto.UsageCount, query.Order),
            _ => collection
        };
    }
}